...
const columbos = [
  ...
  {ep:'S2E05', title: 'Requiem for a Fallen Star', notes: `lots of self referential stuff about the tv industry.
  ...
  notes: ``},
  {ep:'S2E04', title: 'The Dagger of the Mind', notes: 'the british episode! its okay'},
